                ...
                | Some fileText ->
                    match
                        ...
                        Path
                            ...
                            .Equals(".gui", StringComparison.OrdinalIgnoreCase)
                        || Path
                            .GetExtension(path.AsSpan())
                            .Equals(".yml", StringComparison.OrdinalIgnoreCase)
                    with
                                    ...
                                    |> List.map (fun e ->
                                        ...
                                        [| Some("id", JsonValue.String e.id)
                                           ...
                                           Some(
                                               "references",
                                               JsonValue.Array(
                                                   e.references |> Array.ofList |> Array.map referenceToReferences
                                               )
                                           )
                                           ...
                                           e.entityTypeDisplayName
                                           |> Option.map (fun s -> ("entityTypeDisplayName", JsonValue.String s))
